 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\Mall\Goods\ShopManager[] $managerList
 * @property-read int|null $manager_list_count
 * @property-read \App\Models\Mall\Goods\Merchant|null $merchantInfo
