 ...
 *
 * @property int $id
 * @property int $scene 场景：1-添加购物车，2-直接购买
 * @property int $status 购物车商品状态：1-正常，2-SKU失效，3-商品失效
 * @property string $status_desc 购物车商品状态描述
 * @property int $user_id 用户id
 * @property int $shop_id 店铺id
 * @property int $goods_id 商品id
 * @property int $freight_template_id 运费模板id
 * @property int $is_gift 是否为礼包商品
 * @property int $duration 代言时长（天）
 * @property int $refund_status 是否支持7天无理由退货：0-不支持，1-支持
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|CartGoods whereSuperiorPromotionCommissionRate($value)
