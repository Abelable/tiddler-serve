...
class ScenicShopWithdrawalService extends BaseService
{
    ...
    {
        return ScenicShopIncomeWithdrawal::query()
    ...
    {
        $query = ScenicShopIncomeWithdrawal::query();
    ...
    {
        return ScenicShopIncomeWithdrawal::query()->find($id, $columns);
    }
    ...
    {
        return ScenicShopIncomeWithdrawal::query()->where('status', $status)->count();
    }
