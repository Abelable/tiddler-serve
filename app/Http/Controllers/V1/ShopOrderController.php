...
use App\Services\Mall\Goods\GoodsVerifyService;
use App\Services\Mall\Goods\OrderGoodsService;
use App\Services\Mall\Goods\OrderPackageGoodsService;
...
class ShopOrderController extends Controller
{
    ...
    {
        $shopId = $this->verifyRequiredInteger('shopId');
        $count = OrderService::getInstance()->getShopOrderCountByStatusList($shopId, [201, 202]);
