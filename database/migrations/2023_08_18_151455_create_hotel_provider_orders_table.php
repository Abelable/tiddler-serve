...
class CreateHotelProviderOrdersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hotel_provider_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('hotel_provider_orders');
    }
}
