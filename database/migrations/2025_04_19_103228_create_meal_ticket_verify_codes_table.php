...
class CreateMealTicketVerifyCodesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('meal_ticket_verify_codes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('meal_ticket_verify_codes');
    }
}
