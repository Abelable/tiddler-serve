...
class CreateCateringShopIncomeWithdrawalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('catering_shop_income_withdrawals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('catering_shop_income_withdrawals');
    }
}
