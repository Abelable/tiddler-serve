...
class CreateScenicShopIncomeWithdrawalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scenic_shop_income_withdrawals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('scenic_shop_income_withdrawals');
    }
}
