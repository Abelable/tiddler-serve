...
class CreateHotelShopDepositPaymentLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hotel_shop_deposit_payment_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('hotel_shop_deposit_payment_logs');
    }
}
