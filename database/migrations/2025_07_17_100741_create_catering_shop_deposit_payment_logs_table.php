...
class CreateCateringShopDepositPaymentLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('catering_shop_deposit_payment_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('catering_shop_deposit_payment_logs');
    }
}
