...
class CreateScenicShopDepositChangeLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scenic_shop_deposit_change_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('scenic_shop_deposit_change_logs');
    }
}
