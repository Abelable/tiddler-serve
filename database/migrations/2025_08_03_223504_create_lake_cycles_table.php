...
class CreateLakeCyclesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lake_cycles', function (Blueprint $table) {
            $table->id();
            $table->integer('route_id')->comment('路线id');
    ...
    {
        Schema::dropIfExists('lake_cycles');
    }
}
